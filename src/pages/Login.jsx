    ...
    return (
        <div className="relative min-h-screen flex items-center justify-center p-4 overflow-hidden">
            ...
            <div className="absolute inset-0 -z-10 h-full w-full bg-white dark:bg-black">
                ...
                <div className="absolute bottom-0 right-0 h-[400px] w-[400px] bg-[radial-gradient(circle_at_50%_0%,#2dd4bf20,transparent_60%)] blur-[80px]"></div>
            </div>
            ...
            >
                ...
                <form onSubmit={handleSubmit} className="space-y-5">
                    ...
                    <button
                        type="submit"
                        className="w-full bg-emerald-600 hover:bg-emerald-500 text-white font-bold py-3.5 rounded-xl shadow-lg shadow-emerald-500/20 hover:shadow-emerald-500/30 hover:-translate-y-0.5 transition-all flex items-center justify-center gap-2 group"
                    >
